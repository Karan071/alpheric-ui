    ...
    return (
        <section className='max-w-full min-h-screen px-12 flex flex-row items-center gap-20' >
            <div className='flex flex-col gap-9 w-1/2'>
                <h1 className='font-Instrumental-serif text-8xl mt-5'>Answer a few questions to unlock Insights into</h1>
                <h3 className='font-Instrumental-sans italic text-6xl'>Innovation with AI and Cloud</h3>
            </div>
            <div >
            <QuestionaireCard
                key={currentStep}
